...
> El contenido vive en `content/`. Para editar cómodamente, uso Obsidian sobre esa carpeta.
> Cada push a `main` reconstruye y despliega el sitio (ver `.github/workflows/deploy.yml`).

Autor: [Florin Todor](https://florintodor.dev)
